...
**当前状态**：功能完整，架构已优化。PySide6 迁移完成，第三阶段 P0-P5 + Phase 4（T-01~T-05）+ C 系列（C1~C5）+ O 系列（O-01~O-06、O-08~O-09）架构优化已完成（O-07 经评估 YAGNI 关闭），新增单实例保证、CSV 导出、今日未录入提醒、图表稀疏提示、文件日志、现金≤仓库不变式校验、加载结构校验。176 项测试全部通过。
