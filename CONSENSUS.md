...
> **状态**：✅ 已完成（J-01/J-02，2026-08-03，提交 `569b97f`，ADR-0003）
...
- [x] pytest 全绿，新增 `visible(n)` + retention 边界（len>30 删最旧）+ 分栏均分 + 联动烟测
- [x] GUI：按钮组 7/30 切换，切 30 表格 15+15、曲线图 30 条、汇总"最近30条总盈亏"
- [x] 切回 7 不丢数据（数据仍在 30 内）
- [x] 满 30 条不删、录第 31 条才删最旧
- [x] 启动默认 7
