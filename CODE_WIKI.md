...
│   ├── test_kkrb_client.py  ← <!--AUTO:tests:tests/test_kkrb_client.py-->17<!--/AUTO--> 个测试（数据模型 + OV 响应解析）
...
### 4.6 `app/theme.py` — 主题系统（<!--AUTO:lines:app/theme.py-->~625 行<!--/AUTO-->）
...
| `tests/test_kkrb_client.py` | <!--AUTO:tests:tests/test_kkrb_client.py-->17<!--/AUTO--> | 数据模型 + OV 响应解析 |
