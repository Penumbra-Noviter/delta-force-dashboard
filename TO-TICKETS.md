...
> 活跃表（2026-08-01）：O-16~O-19（评审 `082ce62` 录入，见工单详情）。此前 O-11~O-15（P2 第三批）已完成并归档，见「已完成归档」。

| Ticket | 标题 | 类型 | 优先级 | 状态 | 依赖 | 关联 |
|--------|------|------|--------|------|------|------|
| O-16 | CSV 导出大额金额 K/M 缩写精度丢失（决策） | 重构/决策 | P2 | 📝 | | O-11、C3 |
| O-17 | 自动清理提示文案与轮转语义不符 | 修复（文案） | P3 | 📝 | | O-14 |
| O-18 | settings.json 运行态入库清理 | 运维 | P2 | 📝 | | data.json gitignore（`95b7eef`） |
| O-19 | CODE_WIKI 与实现失同步 | 文档 | P3 | 📝 | | O-12 |
