...
|--------|------|------|--------|------|------|------|
| O-01 | logging 替换静默 except | 重构（可观测性） | P0 | 📝 已录入 | — | — |
| O-02 | MoneyLineEdit.refresh_validity 公开 seam | 重构（seam） | P0 | 📝 已录入 | — | — |
| O-03 | format_money docstring 阈值交叉说明 | 文档 | P0 | 📝 已录入 | — | — |
| O-04 | CSV 数据导出 | 功能（新增） | P1 | 📝 已录入 | — | — |
| O-05 | 今日未录入提醒 | 功能（新增） | P1 | 📝 已录入 | — | — |
| O-06 | 图表稀疏数据提示 | 功能（新增） | P2 | 📝 已录入 | — | — |
| O-07 | 收益率目标参考线 | 功能（新增） | P2 | 📝 已录入 | — | — |
